...
from shared_interest._scoring_functions import iou_coverage, saliency_coverage, ground_truth_coverage
...
class TestIoUCoverage(unittest.TestCase):
    ...
    def test_iou_coverage(self):
        ...
        saliency_features[1, 50:250, 100:250] = 1   # ground truth contained in saliency 
        saliency_features[2, 50:100, 50:100] = 1    # saliency contained in ground truth
...
class TestSaliencyCoverage(unittest.TestCase):
    ...
    def test_continuous_saliency_coverage(self):
        ...
        saliency_features[1, 50:250, 100:250] = 0.5   # ground truth contained in saliency 
        saliency_features[2, 50:100, 50:100] = 0.9    # saliency contained in ground truth
...
class TestGroundTruthCoverage(unittest.TestCase):
    ...
    def test_ground_truth_coverage(self):
        ...
        scores = ground_truth_coverage(self.ground_truth_features, saliency_features)
        self.assertTupleEqual(scores.shape, (self.shape[0],))
        self.assertIs(type(scores), np.ndarray)
